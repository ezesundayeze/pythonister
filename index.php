...
<head>
    ...
    <title>Become A professional Python Developer</title>
...
.button { display: inline-block; color: white; background: #199EB8; border: solid #199EB8; border-width: 10px 20px 8px; font-weight: bold; border-radius: 4px; }
...
.container .masthead { padding: 0px 0; background: white; color: white; }
            ...
            <table>
                <tr>
                    <td align="center" class="masthead">
                        ...
                        <img src="https://cdn.dribbble.com/users/926537/screenshots/4502924/python-2.gif" alt="Welcome">
                ...
                <tr>
                    ...
                    <form action="https://gmail.us3.list-manage.com/subscribe/post?u=b2c24afaa0e37031aaee3630f&amp;id=c7db337f16" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                    ...
                    <div class="mc-field-group">
                      ...
                      <div id="mce-responses" class="clear">
                        ...
                        <div class="response" id="mce-success-loading" style="display:none"></div>

                      </div>    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                        <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_b2c24afaa0e37031aaee3630f_c7db337f16" tabindex="-1" value=""></div>
                        <div class="clear" style="margin-left:40%;"><input type="submit" value="Signup" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
                        </div>
                    </form>
                    </div>
                    ...
                    // select the target node
                      ...
                      var loading = document.getElementById('mce-success-loading');
            ...
            <table>
                <tr>
                    <td class="content footer" align="center">
                        <p>Powered by <a href="#">Pythonister</a>, Dutse Abuja, Nigeria</p>
                        <p><a href="mailto:">eze@pythonister.com</a> |<phone>
                            +2349067005754</phone> </p>
                    </td>
                </tr>
            </table>
